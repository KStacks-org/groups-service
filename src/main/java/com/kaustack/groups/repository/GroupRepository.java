...
public interface GroupRepository extends JpaRepository<Group, UUID> {
    ...
    @Query("SELECT g FROM Group g WHERE g.courseId = :courseId AND (g.generalGroupMaleAndFemale = true OR g.gender = :gender)")
    List<Group> findByCourseIdAndGenderOrGeneralForBoth(
